      ...
      <div className="relative z-10 w-full max-w-md mx-4 animate-fadeIn">
        <div className="bg-[#1e1240]/70 backdrop-blur-xl border border-purple-500/20 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-purple-900/30">
          <div className="text-center mb-5">
            ...
            <h1 className="text-2xl font-bold bg-gradient-to-r from-purple-300 via-pink-300 to-purple-400 bg-clip-text text-transparent">MindCare</h1>
            <p className="text-purple-300/50 mt-1 text-sm">Welcome back — sign in to continue</p>
          </div>

          {error && (
            <div className="bg-red-500/15 border border-red-500/40 rounded-xl px-4 py-3 mb-6 text-red-300 text-sm flex items-center gap-2">
          ...
          <p className="text-center text-purple-300/50 text-sm">
            ...
            <button onClick={onGoRegister} className="text-purple-400 hover:text-pink-400 font-semibold transition-colors duration-300">Create one</button>
          </p>
        </div>
